...
const Layout=({children,navigation})=>{
    return(
        ...
        <footer className="p-10 text-white bg-gray-400 flex flex-col sm:flex-row items-start sm:items-center justify-between">
            ...
            <p className="mt-4 sm:mt-0">Pi Bro jamiyati Raspberry Pi haqida ma'lumot beruvchi jamiyat. Jamiyatning asosiy maqsadi Raspberry Pi haqida to'liq ma'lumot berish.</p>
